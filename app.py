...
st.write("اعداد الطالب :يوسف محمد محمد الشرفا")
st.write("مشروع مساق تقنين وبرمجيات نظم المعلومات الجغرافية (2)/ الدكتور محمد حبوب  ")

st.write("ارفع ملفين جغرافيين ثم اختر نوع الربط واعرض النتيجة ونزلها بصيغة GeoJSON")
